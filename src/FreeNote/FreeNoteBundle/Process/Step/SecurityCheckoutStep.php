...
class SecurityCheckoutStep extends ContainerAwareStep
{
    ...
    public function displayAction(ProcessContextInterface $context)
    {
        ...
        return $this->container->get('templating')->renderResponse('FreeNoteBundle:Frontend/Checkout/Step:security.html.twig', array(
            'context'          => $context,
    ...
    {
        $url = $this->container->get('router')->generate('free_note_checkout_start', array(), true);
