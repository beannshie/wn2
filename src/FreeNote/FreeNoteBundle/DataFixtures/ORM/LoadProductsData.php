...
/**
 * Default assortment products to play with.
 *
 */
class LoadProductsData extends DataFixture
{
    ...
    private function createTShirt($i)
    {
        ...
        $product->setImagePath('../../bundles/freenote/images/t-shirt.jpg');
    ...
    private function createSticker($i)
    {
        ...
        $product->setImagePath('../../bundles/freenote/images/sticker.jpg');
    ...
    private function createMug($i)
    {
        ...
        $product->setImagePath('../../bundles/freenote/images/mug.jpg');
    ...
    private function createBook($i)
    {
        ...
        $product->setDescription($this->faker->paragraph);
        $product->setImagePath('../../bundles/freenote/images/book.jpg');
