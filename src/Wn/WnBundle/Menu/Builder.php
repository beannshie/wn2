...
class Builder extends ContainerAware
{
    ...
    public function frontendMainMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('Sklep', array('route' => 'sylius_sandbox_core_frontend'));
        $menu->addChild('Produkty', array('route' => 'sylius_sandbox_product_list'));
        ...
        $child->addChild('Najnowsze wpisy', array('route' => 'sylius_sandbox_post_list'));
        ...
        $menu->addChild('O nas', array('route' => 'sylius_sandbox_about'));
    ...
    public function backendMainMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('Panel', array('route' => 'sylius_sandbox_core_backend'));
    ...
    protected function addSalesMenu(ItemInterface $menu, array $childOptions)
    {
        ...
        $child->addChild('Dodaj zamówienie order', array(
